...
return (
    ...
    <div className={`max-w-screen-3xl  md:px-20 px-4 mx-auto fixed dark:bg-slate-900 dark:text-white top-0 left-0 right-0 z-50 ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out" : ""}`}>
